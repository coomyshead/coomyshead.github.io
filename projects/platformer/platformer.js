$(function () {
  ...
  function setup() {
    ...
    createCannon('right',650,1200,50,50)
    createCannon('right',350,1200,50,50)
    createCannon('right',150,1200,50,50)
